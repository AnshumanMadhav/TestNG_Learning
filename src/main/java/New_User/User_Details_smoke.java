...
public class User_Details_smoke
{
    Response response;
    ...
    public void createSetup()
    {
        ...
        spark = new ExtentSparkReporter(System.getProperty("user.dir")+"/Report/Smoke_Report.html");
        spark.config().setDocumentTitle("Smoke Testing Validation");
        spark.config().setReportName("Regres_Get_API_Details");
        spark.config().setTheme(Theme.DARK);
        logger = extent.createTest("Validate Smoke Testing GET API from Regres Application");
    ...
    @Test
     ...
     {
         System.out.println("User Details for Smoke Testing are as follows");
