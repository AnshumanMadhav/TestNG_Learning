...
public class User_Details_e2e
{
    ...
    public void createSetup()
    {
        ...
        spark = new ExtentSparkReporter(System.getProperty("user.dir")+"/Report/E2E_Report.html");
        spark.config().setDocumentTitle("E2E Validation");
        spark.config().setReportName("Regres_Get_API_Details");
        spark.config().setTheme(Theme.DARK);
        logger = extent.createTest("Validate E2E GET API from Regres Application");
    ...
    @Test
     ...
     {
         System.out.println("User Details for E2E Testing are as follows");
